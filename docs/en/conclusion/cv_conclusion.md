...
This work constitutes a starting point for more in-depth studies, rather than a definitive characterization of the systems considered. Validation based on comparison with experimental results is still needed.
...
- **PINNs (Physics-Informed Neural Networks)**: train a neural network constrained by Butler-Volmer and diffusion equations to accelerate solving
