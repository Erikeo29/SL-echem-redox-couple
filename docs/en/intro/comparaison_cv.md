...
**Contents:**
1. CV vs EIS comparison summary table
...
| **Output** | I=f(E) voltammogram | Nyquist + Bode |
| **Studied parameters** | $k^0$, $\alpha$, $\nu$ | $n$, $k^0$, $D$, $c$, $Q_0$ |
| **Key metrics** | Ipa, Ipc, ΔEp | Rct, σ, Cdl, ω_max |
...
These two studies cover two main approaches for characterizing a ferro/ferricyanide-type redox couple:
